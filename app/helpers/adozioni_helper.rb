module AdozioniHelper
  ...
  def adozioni_dropdown( stato, adozioni, value )
    ...
    render 'adozioni/adozioni_dropdown', value: value, adozioni: adozioni, label_class: label_class
  end
